...
export default function ForgotPasswordForm({
  ...
  return (
    <form onSubmit={handleRecovery}>
      ...
      {recoveryError && (
        <div className="p-3 rounded-lg bg-rose-50 border border-rose-200 text-rose-700 text-xs font-medium mb-3.5 flex items-center gap-2">
      ...
      {recoverySuccess && (
        <div className="p-3 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-medium mb-3.5 flex items-center gap-2">
