    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl border border-slate-100 text-center animate-scaleUp">
        ...
        <p className="text-xs text-slate-600 mb-5 leading-relaxed">
          ...
          <strong className="text-slate-900">{returnToDelete.return_no}</strong> for{' '}
          <strong className="text-slate-900">{returnToDelete.customer_name}</strong>? It will be moved to the Trash bin.
        </p>
