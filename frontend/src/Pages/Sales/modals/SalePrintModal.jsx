...
// Convert numeric amount to words for "Taka In Word"
...
const formatPrintDateTime = (d = new Date()) => {
            ...
            <div style={{ padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              {shareLoading && (
                ...
                >
                  ...
                  {shareStep === 'rendering' && 'Rendering high-resolution invoice document...'}
                  {shareStep === 'uploading' && 'Uploading secure shareable link...'}
                  {shareStep === 'sharing' && 'Opening native share sheet...'}
