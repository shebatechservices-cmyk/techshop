...
CREATE TABLE IF NOT EXISTS payments (
  ...
  CONSTRAINT fk_payments_purchase FOREIGN KEY (purchase_id) REFERENCES purchase_orders(id) ON DELETE CASCADE,
  CONSTRAINT chk_payment_link CHECK ((sale_id IS NOT NULL AND purchase_id IS NULL) OR (sale_id IS NULL AND purchase_id IS NOT NULL))
);
