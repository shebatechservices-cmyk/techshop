...
exports.getAuditLogs = async (req, res) => {
    try {
        ...
        query += ` ORDER BY l.id DESC LIMIT ${parseInt(limit, 10) || 200};`;
...
exports.login = async (req, res) => {
    try {
        ...
        let cleanEmail = lowerId;
        if (cleanEmail === 'shebatechsevices@gmail.com' || cleanEmail === 'shebatechservices@gmail.com') {
            cleanEmail = 'shebatechservices@gmail.com';
        }
        ...
        // Support admin aliases: 'admin', 'superadmin', 'sheba', phone '01722578860', or email
        const isSuperAdminAlias = [
            'admin', 'superadmin', 'super admin', 'administrator', 'sheba', 'shebatech',
            'shebatechservices@gmail.com', 'shebatechsevices@gmail.com', '01722578860', '578860'
        ].includes(lowerId) || digitsOnly === '01722578860';

        // Dynamic Database User Lookup by Phone, Email, Name, or Admin alias
        const userQuery = `
            ...
            WHERE (
                ...
                OR u.phone = $2
                OR LOWER(u.name) = $1
                OR ($3 = true AND u.role_id = 1)
            )
            AND u.deleted_at IS NULL
            ORDER BY (u.role_id = 1) DESC, u.id ASC
            LIMIT 1;
        `;
        const result = await pool.query(userQuery, [cleanEmail, cleanPhone, isSuperAdminAlias]);
        ...
        const isSuperAdmin = (user.role_id === 1 || user.email === 'shebatechservices@gmail.com');
