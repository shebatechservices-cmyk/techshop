...
curl -s -o /dev/null -w "render /api/settings: %{http_code}\n" https://sheba-technology.onrender.com/api/settings

echo "== 4/5 Vercel deploy =="
rm -rf "$PKG/frontend/assets"
...
curl -s -o /dev/null -w "vercel /api/settings: %{http_code}\n" https://$DOMAIN/api/settings
