...
export default function LoginModal({ isOpen, onLoginSuccess, canClose = false, onClose, onOpenDevConsole }) {
  ...
  // Login State - Pre-filled with standard Super Admin credentials
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px', marginBottom: '8px' }}>
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setIdentifier('shebatechservices@gmail.com');
                      setPassword('578860');
                      executeLogin('shebatechservices@gmail.com', '578860');
                    }}
                    disabled={loading}
                    style={{
                      background: '#16a34a',
                ...
                <div style={{ fontSize: '0.76rem', color: '#15803d', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '4px', background: '#dcfce7', padding: '6px 10px', borderRadius: '8px' }}>
                  <span>Email: <strong style={{ color: '#14532d' }}>shebatechservices@gmail.com</strong></span>
                  <span>Pass: <strong style={{ color: '#14532d' }}>578860</strong></span>
                </div>
                ...
                <div style={{ display: 'flex', gap: '6px', marginTop: '8px', flexWrap: 'wrap' }}>
                  <button
                    ...
                    onClick={() => {
                      setIdentifier('shebatechservices@gmail.com');
                      setPassword('578860');
                      setSuccessMsg('✓ Super Admin credentials loaded.');
                      setTimeout(() => setSuccessMsg(''), 2500);
                    }}
                    style={{
                      background: identifier === 'shebatechservices@gmail.com' ? '#16a34a' : '#ffffff',
                      border: '1px solid #86efac',
                      color: identifier === 'shebatechservices@gmail.com' ? '#ffffff' : '#15803d',
                      fontSize: '0.72rem',
                      fontWeight: 700,
                      padding: '3px 8px',
                      borderRadius: '6px',
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setIdentifier('admin@shebatech.com.bd');
                      setPassword('123456');
                      setSuccessMsg('✓ Shop Admin credentials loaded.');
                      setTimeout(() => setSuccessMsg(''), 2500);
                    }}
                    style={{
                      background: identifier === 'admin@shebatech.com.bd' ? '#0284c7' : '#ffffff',
                      border: '1px solid #cbd5e1',
                      color: identifier === 'admin@shebatech.com.bd' ? '#ffffff' : '#334155',
                      fontSize: '0.72rem',
                      fontWeight: 700,
                      padding: '3px 8px',
                      borderRadius: '6px',
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setIdentifier('tanvir@shebatech.com.bd');
                      setPassword('123456');
                      setSuccessMsg('✓ Cashier credentials loaded.');
                      setTimeout(() => setSuccessMsg(''), 2500);
                    }}
                    style={{
                      background: identifier === 'tanvir@shebatech.com.bd' ? '#0284c7' : '#ffffff',
                      border: '1px solid #cbd5e1',
                      color: identifier === 'tanvir@shebatech.com.bd' ? '#ffffff' : '#334155',
                      fontSize: '0.72rem',
                      fontWeight: 700,
                      padding: '3px 8px',
                      borderRadius: '6px',
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setIdentifier('tech1@shebatech.com.bd');
                      setPassword('123456');
                      setSuccessMsg('✓ Technician credentials loaded.');
                      setTimeout(() => setSuccessMsg(''), 2500);
                    }}
                    style={{
                      background: identifier === 'tech1@shebatech.com.bd' ? '#0284c7' : '#ffffff',
                      border: '1px solid #cbd5e1',
                      color: identifier === 'tech1@shebatech.com.bd' ? '#ffffff' : '#334155',
                      fontSize: '0.72rem',
                      fontWeight: 700,
                      padding: '3px 8px',
                      borderRadius: '6px',
              ...
              <div style={{
                ...
                {onOpenDevConsole && (
                  <button
                    ...
                    title="Open Developer Console (Shortcut: Ctrl + Shift + D)"
                  >
                    <span>🛠️ Dev Console</span>
                    <code style={{ background: '#f1f5f9', padding: '1px 5px', borderRadius: '4px', fontSize: '0.68rem', color: '#475569' }}>Ctrl+Shift+D</code>
                  </button>
                )}
              </div>
            </form>
